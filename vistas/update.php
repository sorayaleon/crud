...
// Proceso la información obtenida por el get
if(isset($_POST["id"]) && !empty($_POST["id"])){
   ...
   if(empty($nombreVal)){
       $nombreErr = "Por favor introduzca un nombre válido. Sólo carácteres alfabéticos.";
   ...
   if($_FILES['imagen']['size']>0 && count($errores)==0){
     ...
     // Chequeo errores antes de insertar en la base de datos
